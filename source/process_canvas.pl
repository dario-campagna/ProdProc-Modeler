...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
Class `draw_process_canvas' defines the actual process drawing  area.
Representing a collection  of graphicals, the  closest PCE  class is   `picture'.  In
addition  to pictures, class   draw_process_canvas  takes care of the  current
...
:- pce_begin_class(draw_process_canvas, picture, "").
...
variable(attribute_editor, draw_process_attribute_editor*,	both,		% Create another attribute editor
...
initialise(Canvas) :->
	...
	send(Canvas, recogniser, @draw_process_canvas_recogniser).
...
:- pce_global(@draw_process_canvas_popup, make_draw_canvas_popup).
...
:- pce_global(@draw_process_canvas_keybinding, make_draw_canvas_keybinding).
...
:- pce_global(@draw_process_canvas_recogniser, make_draw_canvas_recogniser).
...
make_draw_canvas_recogniser(G) :-
	...
	new(G, handler_group(
				  @draw_create_activity_recogniser,
				  @draw_create_comp_activity_recogniser,
				  @draw_create_resource_recogniser,
				  @draw_create_tc_recogniser,
				  @draw_create_pv_recogniser,
				  @draw_create_cc_recogniser,
			     @draw_warp_select_gesture,
			     @draw_process_canvas_keybinding,
			     popup_gesture(@draw_process_canvas_popup),
			     ST, EX)).
...
edit_selection(Canvas) :->
	...
	get(Canvas, attribute_editor, Editor),
	(    Editor == @nil
	->   new(A, draw_process_attribute_editor(Canvas)),
